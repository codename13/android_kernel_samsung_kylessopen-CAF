...
#endif
#define _CONFIG_MACH_KYLE // Temporary flag
...
{
	int ret = -EPERM;
#if defined(CONFIG_FB_MSM_MIPI_NT35510_CMD_BOE_WVGA_PT_PANEL)
		if (!strcmp(name, "mipi_cmd_nt35510_boe_wvga"))
			ret = 0;
		else
			ret = -ENODEV;
#elif defined(CONFIG_FB_MSM_MIPI_NT35510_CMD_HYDIS_WVGA_PT_PANEL)
		if (!strcmp(name, "mipi_cmd_nt35510_hydis_wvga"))
			ret = 0;
		else
			ret = -ENODEV;
#endif
